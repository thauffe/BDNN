...
-trait_file /data/users/${user}/BDNN/Simulations/Scenario${scenario}/${SLURM_ARRAY_TASK_ID}/${SLURM_ARRAY_TASK_ID}_traits_pvr_randcont.csv \
-A 0 \
-mG \
